...
class User < ApplicationRecord
  ...
  has_many :created_events, class_name: 'Event', foreign_key: 'owner_id', dependent: :nullify, inverse_of: user
  has_many :tickets, dependent: :nullify, inverse_of: user
  has_many :participating_events, through: :tickets, source: :event, inverse_of: user
